...
@Deprecated
public class CoverageGuidedAlgorithm  <S extends CypherSchema<G,?>, G extends CypherGlobalState<O, S>,
    ...
    public CoverageGuidedAlgorithm(CypherProviderAdapter<G, S, O> provider) {
        super(provider);
    }
