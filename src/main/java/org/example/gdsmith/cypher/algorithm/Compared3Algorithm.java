...
import org.example.gdsmith.cypher.gen.graph.TreeBasedGraphGeneratorCompared;
import org.example.gdsmith.cypher.gen.query.TreeBasedQueryGenerator;
...
@Deprecated
public class Compared3Algorithm<S extends CypherSchema<G,?>, G extends CypherGlobalState<O, S>,
    ...
    public Compared3Algorithm(CypherProviderAdapter<G, S, O> provider) {
        super(provider);
    }
    ...
    public void generateAndTestDatabase(G globalState) throws Exception {
        try {
            ...
            TestOracle oracle = new DifferentialNonEmptyBranchOracle<G, S>(globalState, new TreeBasedQueryGenerator<>(subgraphManager));
...
//            System.exit(0);
    ...
    public void generateDatabase(G globalState) throws Exception{
        TreeBasedGraphGeneratorCompared<G,S> generator = new TreeBasedGraphGeneratorCompared<>(globalState);
