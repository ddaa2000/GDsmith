...
import org.example.gdsmith.cypher.gen.query.TreeBasedQueryGeneratorCompared2;
...
@Deprecated
public class Compared5Algorithm<S extends CypherSchema<G,?>, G extends CypherGlobalState<O, S>,
    ...
    public Compared5Algorithm(CypherProviderAdapter<G, S, O> provider) {
        super(provider);
    }
