...
import org.example.gdsmith.cypher.gen.query.SubgraphGuidedQueryGenerator;
import org.example.gdsmith.cypher.gen.SubgraphManager;
import org.example.gdsmith.cypher.oracle.DifferentialOracle;
...
@Deprecated
public class NonEmptyAlgorithm <S extends CypherSchema<G,?>, G extends CypherGlobalState<O, S>,
    ...
    public NonEmptyAlgorithm(CypherProviderAdapter<G, S, O> provider) {
        super(provider);
    }
    ...
    public void generateAndTestDatabase(G globalState) throws Exception {
        try {
            ...
            TestOracle oracle = new DifferentialOracle<G,S>(globalState, new SubgraphGuidedQueryGenerator<S,G>(subgraphManager));
