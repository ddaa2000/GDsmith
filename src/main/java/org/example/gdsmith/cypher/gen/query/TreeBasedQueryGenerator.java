...
public class TreeBasedQueryGenerator<S extends CypherSchema<G,?>,G extends CypherGlobalState<?,S>> extends SubgraphGuidedQueryGenerator<S,G> {
    ...
    public TreeBasedQueryGenerator(SubgraphManager subgraphManager) {
