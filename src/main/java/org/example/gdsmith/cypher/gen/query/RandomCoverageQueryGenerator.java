...
public class RandomCoverageQueryGenerator<S extends CypherSchema<G,?>,G extends CypherGlobalState<?,S>> extends RandomQueryGenerator<S,G> {
    ...
    public RandomCoverageQueryGenerator(){
        super();
    }
