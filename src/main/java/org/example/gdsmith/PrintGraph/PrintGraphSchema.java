...
import org.example.gdsmith.PrintGraph.PrintGraphSchema.PrintGraphTable;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public class PrintGraphSchema extends CypherSchema<PrintGraphGlobalState, PrintGraphTable> {


    public static PrintGraphSchema createEmptyNewSchema(){
        return new PrintGraphSchema(new ArrayList<PrintGraphTable>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
    }

    //todo complete
    public PrintGraphSchema(List<PrintGraphTable> databaseTables, List<CypherLabelInfo> labels,
    ...
    public List<IFunctionInfo> getFunctions() {
        return Arrays.asList(PrintGraphBuiltInFunctions.values());
    }


    public enum PrintGraphBuiltInFunctions implements IFunctionInfo{
        ...
        PrintGraphBuiltInFunctions(String name, String signature, CypherType expectedReturnType, IParamInfo... params){
            this.name = name;
    ...
    public enum PrintGraphDataType{

    }
    public static class PrintGraphTable extends AbstractTable<PrintGraphTableColumn, TableIndex, PrintGraphGlobalState> {

        //todo complete
        public PrintGraphTable(String name, List<PrintGraphTableColumn> columns, List<TableIndex> indexes, boolean isView) {
            super(name, columns, indexes, isView);
        }

        @Override
        public long getNrRows(PrintGraphGlobalState globalState) {
            return 0;
        }
    }

    public static class PrintGraphTableColumn extends AbstractTableColumn<PrintGraphTable, PrintGraphDataType> {
        //todo complete
        public PrintGraphTableColumn(String name, PrintGraphTable table, PrintGraphDataType type) {
